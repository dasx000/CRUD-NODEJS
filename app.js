...
const {findMahasiswa, addMahasiswa, loadMahasiswa, checkDuplicate} = require('./lib/mahasiswa.js')
...
app.get('/mahasiswa', async (req, res) => {
  ...
  res.render('mahasiswa',{layout: 'layout/main-layout.ejs', title: 'Daftar Mahasiswa' , _m, msg: req.flash('msg')})
})
...
app.get('/add', async (req, res) => {
  ...
  res.render('add',{layout: 'layout/main-layout.ejs', title: 'Tambah Mahasiswa' , _mahasiswa})
})
...
app.post('/mahasiswa', 
  ...
  if (!errors.isEmpty()) {
    res.render('add', {layout: 'layout/main-layout.ejs', title: 'Halaman Tambah Data' , errors: errors.array()})
...
app.get('/mahasiswa/:nama', async (req, res) => {
  ...
  res.render('detail',{layout: 'layout/main-layout.ejs', title: 'Detail Mahasiswa' , detail})
})

app.get('/mahasiswa/edit/:nama', async (req, res) => {
  const edit = await Student.findOne({nama: req.params.nama})
  res.render('edit',{layout: 'layout/main-layout.ejs', title: 'Edit Data' , edit})
})
